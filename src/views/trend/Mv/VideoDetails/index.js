...
class VideoDetails extends React.Component{
            ...
            return (
                <>
                    ...
                    <div style={{display: "none"}} className={"ra_mvdetails_addcom1"}>
                        ...
                        <span onClick={
                            this.props.addCom.bind(this, {
                                t: 2,
                                type: 5,
                                id: this.props.match.params.id,
                                commentId: document.querySelector(".ra_mvdetails_addcom1"),
                                content1: document.querySelector(".ra_mvdetails_addcom_in1")
                            })} className={"ra_mvdetails_new_discuss_in1"}
                              className={"iconfont iconjiantou-copy"}></span>
                    </div>
                    {/************************发评论*********************/}

                    <div className={"ra_mvdetails_addcom"}>
                        <input className={"ra_mvdetails_addcom_in"} placeholder={"写评论"} type="text"/>
                        <span onClick={this.props.addCom.bind(this, {
                            t: 1,
                            type: 5,
                            id: this.props.match.params.id,
                            commentId: "",
                            content1: document.querySelector(".ra_mvdetails_addcom_in")
                        })} className={"iconfont iconjiantou-copy"}></span>
                    </div>
                    {/************************视频*********************/}
                    {
                    ...
                    <div className={"ra_mvdetails_title"}>
                        <div className={"ra_mvdetails_title_top"}>
                            <div className={"ra_mvdetails_title_top_l"}>
                                ...
                                <div>
                                    <span
                                        className={"ra_mvdetails_title_top_l_span1"}>发布：{getpubDate(videoDetails.publishTime)}</span>|
                                    <span
                                        className={"ra_mvdetails_title_top_l_span2"}>播放：{getPlayerTime(videoDetails.playTime)}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div onClick={(e) => {
                        ...
                        <div className={"ra_mvdetails_artist_pic"}>
                            <img style={{position: "absolute", left: "0.2rem", top: "0.2rem"}}
                                 src={videoDetails.creator ? videoDetails.creator.avatarUrl : ""}/>
                        </div>
                        <div className={"ra_mvdetails_artist_name"}>
                            <span>{videoDetails.creator ? videoDetails.creator.nickname : ""}</span>
                        </div>
                        <div onClick={this.props.isFollow.bind(this, {
                            type: videoDetails.creator ? videoDetails.creator.followed ? 0 : 1 : "",
                            id: videoDetails.creator ? videoDetails.creator.userId : "",
                            vid: this.props.match.params.id
                        })} className={"ra_mvdetails_artist_sc"}>
                                ...
                                <div onClick={() => {
                                    ...
                                    <div className={"ra_mvdetails_recom_s_in_img"}>
                                        ...
                                        <div className={"ra_mvdetails_recom_play"}><span
                                            className={"iconfont iconbofang3"}>{getPlayerTime(v.playTime)}</span></div>
                                    </div>
                                    <div className={"ra_mvdetails_recom_s_in_info"}>
                                        <p><span style={{display: v.type ? "none" : ""}}
                                                 className={"ra_mvdetails_recom_s_in_info_mv"}>MV </span>{v.title}</p>
                    ...
                    }} className={"ra_mvdetails_recom"}>精彩评论
                    </div>
                            ...
                            comment.hotComments ? comment.hotComments.map((v, i) => (
                                <div onClick={(e) => {
                                    ...
                                    <div className={"ra_mvdetails_new_discuss_in_user"}>
                                        ...
                                        <div onClick={this.props.isLike.bind(this, {
                                            t: v.liked ? 0 : 1,
                                            id: videoDetails.vid,
                                            type: 5,
                                            cid: v.commentId
                                        ...
                                        }} className={"ra_mvdetails_new_discuss_in_user_z"}>{v.likedCount} <span
                                            className={"iconfont iconthumb"}></span></div>
                                    </div>
                    ...
                    <div onClick={() => {
                        document.querySelector(".ra_mvdetails_addcom1").style.display = "none";
                    }} className={"ra_mvdetails_recom"}>最新评论
                    </div>
                    <div className={"ra_mvdetails_new_discuss"}>
                        {
                                ...
                                <div onClick={(e) => {
                                    ...
                                    <div>
                                        ...
                                        <div style={{
                                            ...
                                            lineHeight: "1rem",
                                            fontSize: "0.36rem"
                                        }}>{v.beReplied.length > 0 ? ("@" + v.beReplied[0].user.nickname + ":" + v.beReplied[0].content) : ""}</div>
    ...
    componentDidMount() {
        ...
        let {page}=this.state;
        this.props.getVideoDetails.bind(this,page,vId)().then(()=>{
            this.setState({
                isLoading:false
            });
            // let onScroll = new BScroll(".ra_box_box_box", {
            //     probeType: 2,
            //     pullDownRefresh: {
            //         threshold: 50,
            //         stop: 20
